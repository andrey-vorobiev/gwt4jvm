...
public final class URL {
    ...
    private static String encodeURIComponent(String decodedURLComponent)
    {
        return encodeImpl(decodedURLComponent)
            .replaceAll("\\+", "%20")
            .replaceAll("%21", "!")
            .replaceAll("%27", "'")
            .replaceAll("%28", "(")
    ...
    {
        return decodeImpl(encodedURLComponent).replace("\\+", "%20");
    }
    ...
    {
        return encodeURIComponent(decodedURLComponent).replace("%20", "+");
    }
